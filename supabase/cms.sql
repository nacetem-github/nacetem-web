...
drop policy if exists "Admins create CMS entries" on public.cms_entries;
drop policy if exists "Admins update CMS entries" on public.cms_entries;
drop policy if exists "Admins delete CMS entries" on public.cms_entries;
